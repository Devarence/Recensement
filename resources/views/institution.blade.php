  ...
  @include('header')
		...
		<div class="container-fluid">
			<div class="col-xs-12 col-sm-12 col-md-12">
					...
					<br>
					<div class="col-xs-12 col-sm-12 col-md-12">
						<form action = "logInstitution" method = "post">
							{{ csrf_field() }}
							<div class="col-xs-6 col-sm-6 col-md-6" style=" position:absolute; top:50%; left:25%; width: 50%">

							<input type="radio" id="Ministere"  name="admin" value="Ministere">
    						<label for="Ministere">MINISTERE</label>

    						<input type="radio" id="Mren" name="admin" value="Dren">
    						<label for="Dren">DREN</label>

    						<input type="radio" id="Iep" name="admin" value="Iep">
