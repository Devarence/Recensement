   ...
   <nav class="navbar navbar-default sidebar" role="navigation">
    ...
    <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        {{ Form::model($date, array('route' => array('date.update', $item->ID), 'method' => 'PUT')) }}
                {{csrf_field()}}
          ...
          <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
           ...
           <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
						  <input type="date" class="form-control has-feedback-left" value= "{{ $item->DateDebut }}" name="datedebut" id="datedebut" placeholder="Date debut">
						<span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
					</div>

          <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
						  <input type="date" class="form-control has-feedback-left" value= "{{ $item->DateFin }}" name="datefin" id="datefin" placeholder="Date fin">
						<span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
					</div>
          
          <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
						<input type="text" class="form-control has-feedback-left" value= "{{ $item->Year }}" name="year" id="year" placeholder="Année">
						<span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
					</div>
